...
const dictionaries: Record<Locale, Record<string, string>> = {
  de: {
    ...
    radarTitle: 'Warum das Handover entscheidend ist',
    radarSubtitle: 'Jede korrekt \u00fcbergebene Information spart Geld im Facility Management',
    radarAssets: 'Anlagen',
    radarDocs: 'Dokumente',
    radarGaranties: 'Garantien',
    radarSnags: 'Snags',
    radarSavingsLabel: 'J\u00e4hrliche Einsparung',
    radarPerYear: '/ Jahr',
    radarInstruction: 'Klicken Sie auf die Kategorien, um den Einfluss jeder Daten\u00fcbergabe auf Ihre FM-Kosten zu sehen',
  },
  fr: {
    ...
    logout: 'Déconnexion',
    settings: 'Param\u00e8tres',
    radarTitle: 'Pourquoi le Handover est critique',
    radarSubtitle: 'Chaque donn\u00e9e correctement transf\u00e9r\u00e9e \u00e9conomise de l\u2019argent en Facility Management',
    radarAssets: '\u00c9quipements',
    radarDocs: 'Documents',
    radarGaranties: 'Garanties',
    radarSnags: 'Snags',
    radarSavingsLabel: '\u00c9conomie annuelle',
    radarPerYear: '/ an',
    radarInstruction: 'Cliquez sur les cat\u00e9gories pour voir l\u2019impact de chaque transfert de donn\u00e9es sur vos co\u00fbts FM',
  },
};
